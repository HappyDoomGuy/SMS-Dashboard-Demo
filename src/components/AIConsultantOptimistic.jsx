...
**РАЗДЕЛ 1: САМЫЕ ЭФФЕКТИВНЫЕ SMS ИЗ ПРОШЛЫХ КАМПАНИЙ** 📊

Выведи топ-5 самых эффективных SMS из предоставленных данных A/B тестов:
- Отсортируй по количеству просмотров и % просмотра
- Для каждого укажи:
  * Текст SMS (полностью)
  * Группа A/B
  * Кампания
  * Просмотров
  * Средний % просмотра
- Формат простого списка

**РАЗДЕЛ 2: НОВЫЕ ВАРИАНТЫ ТЕКСТОВ SMS** 📝

**A) 5 вариантов на основе эффективности прошлых:**
- Используй ПРИНЦИПЫ из топ-5 самых эффективных SMS
- НЕ копируй тексты, создавай НОВЫЕ
- Применяй успешные паттерны в свежем контексте
- Формат для каждого:
  **Вариант 1:**
  [полный новый текст SMS]
  *Принцип:* [какой успешный принцип использован]

**B) 5 вариантов для экспериментов (новизна):**
- Предложи НОВЫЕ подходы, которые еще не тестировались
- Смелые гипотезы для проверки
- Инновационные формулировки
- Формат для каждого:
  **Вариант 6:**
  [полный новый текст SMS]
  *Гипотеза:* [что тестируем, почему может сработать]

**РАЗДЕЛ 3: ОБЩИЕ РЕКОМЕНДАЦИИ** 💡

На основе анализа всей конверсии дай:
- Общие паттерны успешных SMS
- Что повышает конверсию в данной аудитории
- Рекомендации по времени отправки
- Советы по персонализации для разных специальностей
- Ключевые принципы для следующих кампаний

КРИТИЧЕСКИ ВАЖНО: 
- СТРОГО следуй порядку: Топ-5 эффективных → 5 на основе эффективности → 5 новых → Общие рекомендации
- Все новые тексты должны быть ОРИГИНАЛЬНЫМИ
- НЕ копируй старые SMS
- Используй ДАННЫЕ для выявления принципов успеха`;
