...
1. **📝 7 ВАРИАНТОВ ТЕКСТОВ SMS для повышения конверсии**:
   - Проанализируй SMS из A/B тестов, которые показали БОЛЬШЕ просмотров и выше % просмотра
   - На основе САМЫХ УСПЕШНЫХ SMS создай 7 новых вариантов
   - Каждый вариант должен быть УЛУЧШЕННОЙ версией успешного SMS
   - Сохрани работающие элементы, усиль слабые
   - Каждый вариант - ПОЛНЫЙ текст SMS, готовый к использованию
   - Варианты должны быть направлены на ПОВЫШЕНИЕ КОНВЕРСИИ
   - Формат: 
     **Вариант 1:**
     [полный текст SMS]
     *Основа:* [на базе какого успешного SMS из A/B тестов]
...
ВАЖНО: 
- НАЧНИ с 7 вариантов текстов SMS
- БАЗИРУЙ каждый вариант на САМЫХ УСПЕШНЫХ SMS из A/B тестов (больше просмотров, выше %)
- Каждый вариант - УЛУЧШЕННАЯ версия успешного SMS для ПОВЫШЕНИЯ КОНВЕРСИИ
- Укажи на базе какого SMS создан вариант
- Объясни ЧТО именно улучшает конверсию
- Каждый вариант - ПОЛНЫЙ текст, готовый к использованию
- НЕ давай общих советов, используй КОНКРЕТНЫЕ данные из A/B тестов`;
