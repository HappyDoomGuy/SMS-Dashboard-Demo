...
1. **📝 10-15 ГОТОВЫХ ВАРИАНТОВ ТЕКСТОВ SMS для следующей кампании**:
   - Предложи 10-15 конкретных вариантов текста SMS
   - Каждый вариант должен быть ПОЛНЫМ текстом, готовым к использованию
   - Используй инсайты из A/B тестов
   - Варьируй подходы: разные заголовки, призывы, тон, длина
   - Нумеруй каждый вариант
   - Формат: "Вариант 1: [полный текст SMS]"
   - После каждого варианта кратко укажи его особенность (1 строка)
...
ВАЖНО: 
- НАЧНИ с 10-15 готовых вариантов текстов SMS
- Каждый вариант - ПОЛНЫЙ текст, готовый к копированию
- АНАЛИЗИРУЙ конкретные тексты из A/B тестов
- СРАВНИВАЙ что работает в разных вариантах
- НЕ давай общих советов, используй реальные данные
- Формат вариантов: "Вариант 1: [текст]" + краткое пояснение`;
